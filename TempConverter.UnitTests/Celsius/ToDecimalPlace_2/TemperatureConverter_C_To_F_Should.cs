...
namespace TempConverter._UnitTests.Celsius.ToDecimalPlace_2
{
    [TestFixture]
    public class TemperatureConverter_C_To_F_Should
    {
        ...
        public void Init()
        {
            _celsiusToFahrenheit = TemperatureConverter.CelsiusToFahrenheit;
        ...
        {          
            double actual = _temperatureConverter.ConvertTemperature(temperature, _celsiusToFahrenheit, RoundBy);
