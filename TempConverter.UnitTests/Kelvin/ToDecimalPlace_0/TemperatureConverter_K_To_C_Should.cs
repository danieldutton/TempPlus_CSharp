...
namespace TempConverter._UnitTests.Kelvin.ToDecimalPlace_0
{
    [TestFixture]
    public class TemperatureConverter_K_To_C_Should
    {
        ...
        public void Init()
        {
            _kelvinToCelsius = TemperatureConverter.KelvinToCelsius;
                    ...
                    [Values(-103, -102, -101, -100, -99, -98, -97, -96, -95, -94, -93)]double expected)
        {
            ...
            double actual = _temperatureConverter.ConvertTemperature(temperature, _kelvinToCelsius, RoundBy);
