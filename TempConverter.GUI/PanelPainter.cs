    ...
    public class PanelPainter
    {
        ...
        public void PaintFahrenheitPanel(PaintEventArgs e, Scale<int> scale)
        {
            ...
            if (panelPaintArgs.Temperatures.Fahrenheit > 0)
            {
                ...
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Yellow), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Fahrenheit /
            ...
            {
                RefreshPanelPaint(panelPaintArgs);
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Red), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Fahrenheit /
        ...
        public void PaintCelsiusPanel(PaintEventArgs e, Scale<int> scale)
        {
            ...
            {
                RefreshPanelPaint(panelPaintArgs);
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Yellow), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Celsius /
                scale.ScaleBy, height: GraphBarHeight);
            }
            ...
            {
                RefreshPanelPaint(panelPaintArgs);
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Red), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Celsius /
                scale.ScaleBy * -1, height: GraphBarHeight);
            }
        }
        ...
        public void PaintKelvinPanel(PaintEventArgs e, Scale<int> scale)
        {
            ...
            {
                RefreshPanelPaint(panelPaintArgs);
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Yellow), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Kelvin /
                scale.ScaleBy, height: GraphBarHeight);
            }
            ...
            {
                RefreshPanelPaint(panelPaintArgs);
                panelPaintArgs.Graphics.FillRectangle(new SolidBrush(Color.Red), x: 0, y: 0, width: (int)panelPaintArgs.Temperatures.Kelvin /
                scale.ScaleBy * -1, height: GraphBarHeight);
            }
        }
